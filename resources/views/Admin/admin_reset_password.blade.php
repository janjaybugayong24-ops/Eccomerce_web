               ...
               <div class="col-md-6 right-box">
                  ...
                  <div class="row align-items-center">
                         ...
                         <div class="input-group mb-3">
                               <input type="email" name="password"  class="form-control form-control-lg bg-light fs-6" required placeholder="Password">
                         </div>

                         <div class="input-group mb-3">
                               <input type="password" name="confirm_password"  class="form-control form-control-lg bg-light fs-6" required placeholder="Confirm Password">
                         </div>
